...
public class EIProject_Acquire_GetCertificate extends Activity implements SurfaceHolder.Callback
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.acquire_camera);
		setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
		intent = this.getIntent();
		mSurfaceView01 = (SurfaceView) findViewById(R.id.mSurfaceView1);
		mSurfaceHolder01 = mSurfaceView01.getHolder();
		mSurfaceHolder01.addCallback(EIProject_Acquire_GetCertificate.this);
					...
					try {
				        ...
				        if(decryptedText!="")
				        {
				            if (decryptedText.indexOf("Exception")>-1)
				            {
				            	...
				            	EIProject_Acquire_GetCertificate.this.setResult(RESULT_OK,intent);
				            	
				            	EIProject_Acquire_GetCertificate.this.finish();
				            }
				        }
					}catch (Exception e) {
