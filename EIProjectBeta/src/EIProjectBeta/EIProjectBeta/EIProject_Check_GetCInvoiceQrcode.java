...
public class EIProject_Check_GetCInvoiceQrcode extends Activity implements SurfaceHolder.Callback
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		mSurfaceHolder01.addCallback(EIProject_Check_GetCInvoiceQrcode.this);
					...
					try {
				        ...
				        if(decryptedText!="")
				        {
				            if (decryptedText.indexOf("Exception")>-1)
				            {
				            	...
				            	EIProject_Check_GetCInvoiceQrcode.this.setResult(RESULT_OK,intent);
				            	
				            	EIProject_Check_GetCInvoiceQrcode.this.finish();
				            }
				        }
					}catch (Exception e) {
