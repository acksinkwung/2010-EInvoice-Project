...
public class EIProject_Help_Select_Org extends EIProject_Help_Select_Detail {
	                ...
	                btnHelpOrg.setOnClickListener(new OnClickListener() {
	        			...
	        			public void onClick(View v) {
							...
							if (GetHTML("http://140.118.9.68/match/?iid="+IID+"&C="+IID_C+"&R="+IID_R+"&DonateID="+String.valueOf(selNum)).equals("success")) {
							    ...
							    db.insertDonate(sdf.format(c1.getTime()).toString(), IID,(alOrgIData.get(selNum)).get("ItemOrgId").toString());
								db.update_invoicedetail(IID);
								db.deleteP(IID);
							    setContentView(R.layout.help_main_success);
							}
